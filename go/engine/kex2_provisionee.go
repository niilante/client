...
func (e *Kex2Provisionee) handleDidCounterSign(sig []byte, sdhBoxes []keybase1.SharedDHSecretKeyBox) (err error) {
	...
	e.localDelegateFn = func(u *libkb.User) (err error) {
		...
		err = u.LocalDelegateKey(e.eddsa, decSig.sigID, e.eddsa.GetKID(), true /*isSibkey*/, false /*isEldest*/)
		if err != nil {
			return err
		}
		...
		err = u.LocalDelegateKey(e.dh, dhSigID, e.dh.GetKID(), false /*isSibkey*/, false /*isEldest*/)
		return err
	}
...
// updateUser call LocalDelegateKey on the local user.
...
func (e *Kex2Provisionee) updateUser(u *libkb.User) error {
	if e.localDelegateFn == nil {
		return fmt.Errorf("updateUser called before successful provision")
	}
